...
public class ProportionTest
{
    ...
    public void test_builder()
    {
        ...
        Assert.assertEquals("20.00% size @ 80.00% likelihood, 70.00% size @ 15.00% likelihood, 10.00% size @ 5.00% likelihood", prop
                .toString(", "));
    }
    ...
    public void test_chooseAscendingDeterministic()
    {
        ...
        for (double i = 0.00; i < 0.80; i += 0.01)
        {
            ...
            Assert.assertTrue("The top 80% of 'random' numbers should result in a number chosen from the top 20% of the range:" + nextFrom,
                    nextFrom >= 0 && nextFrom <= 20);
        }
    ...
    public void test_chooseDescendingDeterministic()
    {
        ...
        for (double i = 0.00; i < 0.75; i += 0.01)
        {
            ...
            Assert.assertTrue(String.format(
                    "The top 75%% of 'random' numbers should result in a number chosen from the top 10%% of the range: %.2f => %d", i,

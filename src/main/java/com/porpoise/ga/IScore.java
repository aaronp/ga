...
/**
 * Represents the value of a sequence. Better scores should come first. If, for example, a score was simply an integer value, then the score
 * of 0 would be better than one of 7.
 * 
 * @param <T>
 */

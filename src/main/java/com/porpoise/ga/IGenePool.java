 ...
 * as well as cull its population via {@link #thinPopulation()}
 */
public interface IGenePool extends Iterable<GeneSequence> {
     ...
     * 
     * This is a callback method, notifying (asking) the gene pool to cull/thin out its population.
     * 
     * This will presumably be based on fitness, though what actually happens will be up to the implementation.
     * 
     * This method may not have any affect, and after calling the total population may be less than, equivalent to or
     * even greater than the population before calling.
     */
    void thinPopulation();
